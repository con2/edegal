            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                {photographer && photographer.email ? (
                  <p>
                    <strong>{t('contact')}</strong> {photographer.email}
                  </p>
                ) : null}
                ...
                {haveInstagram ? (
                  <>
                    ...
                    <p>
                      ...
                      {director ? (
                        <>
                          {t('director')}: {director.instagram_handle ? `@${director.instagram_handle}` : director.display_name}
                          <br />
                        </>
                      ) : null}
                    </p>
                ...
                {haveCredit ? (
                  <>
                    <p>
                      <strong>{haveTwitter || haveInstagram ? t('genericCredit') : t('genericCreditAlternative')}</strong>
                    </p>
                    <p>
