...
const translations: Translations = {
  ...
  DownloadAlbumDialog: {
    ...
    threadsCredit: 'Jos käytät näitä kuvia Threadsissä, ilmoita tekijä seuraavasti:',
    blueskyCredit: 'Jos käytät näitä kuvia Blueskyssa, ilmoita tekijä seuraavasti:',
  ...
  DownloadDialog: {
    ...
    twitterCredit: 'Jos käytät tätä kuvaa Twitterissä, ilmoita tekijä seuraavasti:',
    instagramCredit: 'Jos käytät tätä kuvaa Instagramissa, ilmoita tekijä seuraavasti:',
    threadsCredit: 'Jos käytät tätä kuvaa Threadsissä, ilmoita tekijä seuraavasti:',
    blueskyCredit: 'Jos käytät tätä kuvaa Blueskyssa, ilmoita tekijä seuraavasti:',
