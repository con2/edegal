const translations = {
  ...
  DownloadAlbumDialog: {
    ...
    threadsCredit: 'If you use these pictures in Threads, please credit the author as follows:',
    blueskyCredit: 'If you use these pictures in Bluesky, please credit the author as follows:',
  ...
  DownloadDialog: {
    ...
    threadsCredit: 'If you use this picture in Threads, please credit the author as follows:',
    blueskyCredit: 'If you use this picture in Bluesky, please credit the author as follows:',
