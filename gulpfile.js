...
var config = {
  destination: './gallery/static/gallery',
  scripts: {
    source: './gallery/static_src/main.js',
    destination: './gallery/static/gallery/js/',
    extensions: ['.jsx'],
    filename: 'bundle.js'
  },
  templates: {
    source: './gallery/static_src/*.jade',
    watch: './gallery/static_src/*.jade',
    destination: './gallery/static/gallery/',
    revision: './gallery/static/gallery/**/*.html'
  },
  styles: {
    source: './gallery/static_src/style.styl',
    watch: './gallery/static_src/**/*.styl',
    destination: './gallery/static/gallery/css/'
  },
  assets: {
    source: './gallery/static_src/assets/**/*.*',
    watch: './gallery/static_src/assets/**/*.*',
    destination: './gallery/static/gallery/'
  },
  revision: {
    source: ['./gallery/static/gallery/**/*.css', './gallery/static/gallery/**/*.js'],
    base: path.join(__dirname, 'gallery/static/gallery'),
    destination: './gallery/static/gallery/'
  }
};
