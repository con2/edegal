const translations = {
  ...
  ManagePhotographers: {
    ...
    form: {
      ...
      slug: "Slug",
      slugHelp:
        "Part of the profile's address. Changing it later breaks existing links to that page.",
      visibility: "Visibility",
      visibilityPublic: "Public",
      visibilityHidden: "Hidden",
      visibilityPrivate: "Private",
      ...
      defaultTerms: "Default conditions of use for new albums",
      account: "Account",
      accountNone: "Not linked",
      accountCandidateHint: "Suggested match by email:",
      accountLinkedElsewhere: "already linked to",
      save: "Save",
    },
    saved: "Profile saved.",
    slugTaken: "This slug is already in use by another photographer.",
    userTaken: "That account is already linked to another profile.",
    merge: {
      title: "Merge another profile into this one",
      help: "Moves the other profile's credits and links here, fills in anything missing here from it, and makes its page redirect here. The other profile is then deleted permanently.",
      target: "Profile to merge in",
      submit: "Merge and delete the other profile",
      confirm:
        "Merge the chosen profile into this one and delete it permanently?",
      merged: "Profiles merged.",
      differentUsers:
        "Both profiles are linked to different accounts. Unlink one first.",
    },
  },
  ContactDialog: {
