...
const translations: Translations = {
  ...
  Profile: {
    ...
    visibility: "Näkyvyys",
    visibilityPublic: "Julkinen",
    visibilityPublicHelp: "Näkyy kuvaajaluettelossa ja on kaikkien nähtävissä.",
    visibilityHidden: "Piilotettu",
    visibilityHiddenHelp:
      "Ei näy kuvaajaluettelossa, mutta on nähtävissä osoitteen tietävälle.",
    visibilityPrivate: "Yksityinen",
  ...
  ManagePhotographers: {
    ...
    list: {
      displayName: "Nimi",
      account: "Tunnus",
      notLinked: "Ei yhdistetty",
      credits: "Tekijätietoja",
      edit: "Muokkaa",
      quickLink: "Yhdistä tunnukseen",
    },
    form: {
      displayName: "Näyttönimi",
      slug: "Osoitetunnus",
      slugHelp:
        "Osa profiilin osoitetta. Muuttaminen jälkikäteen rikkoo vanhat linkit sivulle.",
      visibility: "Näkyvyys",
      visibilityPublic: "Julkinen",
      visibilityHidden: "Piilotettu",
      visibilityPrivate: "Yksityinen",
      ...
      addLink: "Lisää linkki",
      removeLink: "Poista",
      defaultTerms: "Oletusehdot uusille albumeille",
      account: "Tunnus",
      accountNone: "Ei yhdistetty",
      accountCandidateHint: "Ehdotettu vastaavuus sähköpostin perusteella:",
      accountLinkedElsewhere: "yhdistetty jo tunnukseen",
      save: "Tallenna",
    },
    saved: "Profiili tallennettu.",
    slugTaken: "Tämä osoitetunnus on jo toisen kuvaajan käytössä.",
    userTaken: "Tämä tunnus on jo yhdistetty toiseen profiiliin.",
    merge: {
      title: "Yhdistä toinen profiili tähän",
      help: "Siirtää toisen profiilin tekijätiedot ja linkit tähän, täydentää tästä puuttuvat tiedot toisesta, ja ohjaa toisen profiilin sivun tänne. Toinen profiili poistetaan tämän jälkeen pysyvästi.",
      target: "Yhdistettävä profiili",
      submit: "Yhdistä ja poista toinen profiili",
      confirm: "Yhdistetäänkö valittu profiili tähän ja poistetaan pysyvästi?",
      merged: "Profiilit yhdistetty.",
      differentUsers:
        "Molemmat profiilit on yhdistetty eri tunnuksiin. Pura toinen yhdistys ensin.",
    },
  },
  ContactDialog: {
