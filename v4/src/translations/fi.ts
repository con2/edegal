...
const translations: Translations = {
  ...
  Upload: {
    ...
    title: "Lataa kuvia",
    help: "JPEG, PNG tai WebP, enintään 100 Mt per tiedosto. Esikatselukuvat tehdään taustalla latauksen jälkeen. Kuvat järjestetään kuvausajan mukaan.",
